...
# %% auto #0
__all__ = ['example_markdown_fr', 'split_lines', 'parse_bullet_line', 'add_bullet_to_container', 'new_subsection_container',
           'markdown_to_nested_dict']

# %% ../nbs/00_core.ipynb #6c8f387f
...
# %% ../nbs/00_core.ipynb #5c178468
import re
def split_lines(markdown: str) -> list[str]:
    return markdown.replace("\r\n", "\n").replace("\r", "\n").split("\n")


# %% ../nbs/00_core.ipynb #c3ccd9cb
